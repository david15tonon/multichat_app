...
**API FastAPI pour MultiChat avec authentification JWT, gestion de conversations avec Supabase et traduction IA.**
...
- [🔄 WebSocket](#-websocket)
- [📝 Variablesvenvironnement](#-variables-denvironnement)
- [🧪 Tests](#-tests)
...
- **🔑 Security** - CORS, rate limiting, validation Pydantic
...
│   └── schemas/
│       ├── __init__.py
│       ├── auth.py              # Schemas pour auth (request/response)
...
# 5. Créer le fichier .env (voir section Variables)
touch .env
